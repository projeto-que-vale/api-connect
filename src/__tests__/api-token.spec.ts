import {ApiToken, ApiTokenApplicationType, ApiTokenAuthContextType, ApiTokenProfileType, ApiTokenType} from '../security/token/api-token';
...
describe('ApiToken', () => {
    ...
    it('Verifica a hora de emissão do token (iat)', async () => {
        const test: boolean = apiToken.emission <= ApiUtil.createdAt();
